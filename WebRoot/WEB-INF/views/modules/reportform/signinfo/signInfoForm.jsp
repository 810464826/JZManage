...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/signinfo/signInfo/">扫码中奖统计列表</a></li>
		<li class="active"><a href="${ctx}/signinfo/signInfo/form?id=${signInfo.id}">扫码中奖统计<shiro:hasPermission name="signinfo:signInfo:edit">${not empty signInfo.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="signinfo:signInfo:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="signInfo" action="${ctx}/signinfo/signInfo/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="deliveryTime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${signInfo.deliveryTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div class="form-actions">
			<shiro:hasPermission name="signinfo:signInfo:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
