...
<body>
	...
	<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/user/info" method="post" class="form-horizontal"><%--
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="phone" htmlEscape="false" maxlength="50" id="phoneText"/>
			</div>
		</div>
		<div class="control-group" id="mobile">
			<label class="control-label">手机:</label>
			<div class="controls">
				<form:input path="mobile" htmlEscape="false" maxlength="50" id="mobileText" />
			</div>
		</div>
		<div class="control-group">
