...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/turntableprize/turntablePrize/">转盘中奖记录列表</a></li>
		<li class="active"><a href="${ctx}/turntableprize/turntablePrize/form?id=${turntablePrize.id}">转盘中奖记录<shiro:hasPermission name="turntableprize:turntablePrize:edit">${not empty turntablePrize.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="turntableprize:turntablePrize:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="turntablePrize" action="${ctx}/turntableprize/turntablePrize/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="deliveryTime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${turntablePrize.deliveryTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div class="form-actions">
			<shiro:hasPermission name="turntableprize:turntablePrize:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
