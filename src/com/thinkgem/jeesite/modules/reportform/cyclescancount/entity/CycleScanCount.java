 ...
 */
package com.thinkgem.jeesite.modules.reportform.cyclescancount.entity;
 ...
 * @version 2017-07-06
 */
public class CycleScanCount extends DataEntity<CycleScanCount> {
	...
	private String outProvinces;		// 是否属于外省  1属于  0不属于
	...
	public CycleScanCount() {
		super();
	}

	public CycleScanCount(String id){
		super(id);
	}
	...
	@Length(min=0, max=255, message="是否属于外省  1属于  0不属于长度必须介于 0 和 255 之间")
