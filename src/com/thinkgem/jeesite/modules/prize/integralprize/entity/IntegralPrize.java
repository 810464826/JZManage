 ...
 */
package com.thinkgem.jeesite.modules.prize.integralprize.entity;
 ...
 * @version 2017-07-05
 */
public class IntegralPrize extends DataEntity<IntegralPrize> {
	...
	public IntegralPrize(String id){
		super(id);
	}
