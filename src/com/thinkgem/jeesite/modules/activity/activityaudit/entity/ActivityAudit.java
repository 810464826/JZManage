 ...
 */
package com.thinkgem.jeesite.modules.activity.activityaudit.entity;
 ...
 * @version 2017-03-24
 */
public class ActivityAudit extends DataEntity<ActivityAudit> {
	...
	public ActivityAudit(String id){
		super(id);
	}
