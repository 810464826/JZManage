...
//		systemRealm.clearAllCachedAuthorizationInfo();
	 ...
	 * 根据公司id删除相应的用户
	 */
	public void deleteUser(String officeId){
		userDao.deleteUser(officeId);
	}
	
	/**
	 * 根据公司id查询该经销商的用户
	 */
	public List<User> findDeleteUserByOfficeId(String officeId){
		return userDao.findDeleteUserByOfficeId(officeId);
	}
